...
app.engine('.hbs', exphbs({extname : ".hbs",   //Tells server how to hadnle HTML files thar formatted using handlebar's format(.hbs)
...
app.use(clientSessions({
  ...
  secret: "Tais_BTI325_A6", // this should be a long un-guessable string.
